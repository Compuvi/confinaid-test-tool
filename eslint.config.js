...
export default tseslint.config(
  {
    ignores: ["dist", "coverage", "node_modules", "src-tauri/target", "src-tauri/gen", "target"],
  },
  {
    ...
    rules: {
      ...
      // Underscore prefix is the house escape hatch for intentionally unused
      // bindings (matches confinaid-frontend).
